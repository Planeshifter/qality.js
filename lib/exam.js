...
Examination.Resolution = function() {
  var self = this;
		...
		var s =
            `<div class = "result"><h1>RESULT</h1>
                <div id = "assessment">
            		...
            		<h3><span class = "pcaps">Evaluation</span> ${self.get_evaluation(res.percentage)}</h3>
            		<h3><span class = "pcaps">Assessment</span> ${res.text}</h3>
                </div>
            </div>`;
